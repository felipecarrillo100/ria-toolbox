...
import {CameraFeature, OverviewCameraLayer, OverviewFrustumLayer} from "./types.js";
...
export function createCameraLayers(mainMap: WebGLMap): {
  cameraLayer: OverviewCameraLayer;
  cameraFrustumLayer: OverviewFrustumLayer;
  cameraHandle: Handle;
} {
